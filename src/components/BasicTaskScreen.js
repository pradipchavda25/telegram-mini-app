...
const INITIAL_TASKS = [
  ...
  },
  {
    ...
    taskId: "join_sharpe_discord",
  },
  {
    id: "telegram_sharpe_group",
    ...
    taskId: "join_sharpe_telegram",
  },
  {
    id: "telegram_sharpe_channel",
    name: "Join the Sharpe AI telegram announcement channel",
    reward: 200,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://t.me/Sharpe_AI_Official",
    verifier: TASK_TYPES.TELEGRAM,
    taskId: "join_sharpe_telegram_ac",
  },
  {
    id: "telegram_bro_group",
    name: "Join the Brownian telegram group",
    reward: 200,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://t.me/Brownianxyz",
    verifier: TASK_TYPES.TELEGRAM,
    taskId: "join_brownian_telegram",
  },
  {
    id: "telegram_bro_channel",
    name: "Join the Brownian telegram announcement channel",
    reward: 200,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://t.me/SharpeAI_Official",
    verifier: TASK_TYPES.TELEGRAM,
    taskId: "join_brownian_telegram_ac",
  },
  {
    id: "youtube_bro_channel",
    name: "Subscribe to the Brownian Youtube Channel",
    reward: 200,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://t.me/BrownianChannel",
    verifier: TASK_TYPES.YOUTUBE,
    taskId: "join_brownian_youtube",
  },
  {
    id: "youtube_sharpe_channel",
    name: "Subscribe to the Sharpe AI Youtube Channel",
    reward: 200,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://www.youtube.com/@Sharpe_AI",
    verifier: TASK_TYPES.YOUTUBE,
    taskId: "join_sharpe_youtube",
  },
  {
    id: "twitter_bro_username",
    name: "Add “$BRO 🤙” to your X username",
    reward: 500,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://twitter.com/settings/profile",
    verifier: TASK_TYPES.TELEGRAM,
    taskId: "added_bro_x_username",
  },
  {
    id: "telegram_bro_username",
    name: "Add “$BRO 🤙” to your Telegram username",
    reward: 500,
    icon: FaTelegramPlane,
    modalButtonText: "Join",
    link: "https://t.me/SharpeAI_Official",
    verifier: TASK_TYPES.TELEGRAM,
    taskId: "added_bro_tg_username",
  },
];
      ...
      >
        <div className="flex flex-row items-center gap-2 flex-1">
          ...
          <div className="flex-1 text-left">
            <motion.p
              className="font-normal text-white text-[14px] pr-2"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        {task.completed ? (
          ...
          <motion.div
            className="flex items-center justify-center text-white bg-[#1d1d1d] rounded-full text-[14px] py-[4px] w-[70px]"
